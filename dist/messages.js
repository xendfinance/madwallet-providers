...
const messages = {
    errors: {
        disconnected: () => 'MadWallet: Disconnected from chain. Attempting to connect.',
        permanentlyDisconnected: () => 'MadWallet: Disconnected from MadWallet background. Page reload required.',
        sendSiteMetadata: () => `MadWallet: Failed to send site metadata. This is an internal error, please report this bug.`,
        unsupportedSync: (method) => `MadWallet: The MadWallet Ethereum provider does not support synchronous methods like ${method} without a callback parameter.`,
        invalidDuplexStream: () => 'Must provide a Node.js-style duplex stream.',
        invalidNetworkParams: () => 'MadWallet: Received invalid network parameters. Please report this bug.',
    ...
    info: {
        connected: (chainId) => `MadWallet: Connected to chain with ID "${chainId}".`,
    },
    warnings: {
        // deprecated methods
